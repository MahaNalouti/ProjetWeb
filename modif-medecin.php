		...
		<main>
			...
			<div class="data">
				...
				<div class="content-data">
					<div class="head">
						<h3>Formulaire</h3>
						<a href="list-medecin.php" class="btn-green">Retourner</a>
					</div>
						<div>
                        <?php 
            ...
            <form action="" method="post" id="form">
                                ...
                                <div class="form-group input-control">
                                    ...
                                    autocomplete="off" placeholder="Entrer nom" value="<?php echo $medecin['nom']?>" >
                                    <div class="error"></div>
                            </div>
                            <div class="form-group input-control">
                                <label for="" >Prenom</label>
                                <input type="text" name="Prenom" id="Prenom" class="form-control" 
                                autocomplete="off" value="<?php echo $medecin['prenom']?>">
                                <div class="error"></div>
                            ...
                            <div class="form-group input-control">
                                ...
                                autocomplete="off" value="<?php echo $medecin['unom']?>" >
                                <div class="error"></div>
                            </div>
                            <div class="form-group input-control">
                                <label for="">Email</label>
                                <input type="text" name="email" id="email" class="form-control" 
                                autocomplete="off" value="<?php echo $medecin['email']?>">
                                <div class="error"></div>
                            </div>
                            <div class="form-group input-control">
                            ...
                            <div class="form-group input-control">
                                    ...
                                    autocomplete="off" value='<?php echo $medecin['tel']?>'>
                                    <div class="error"></div>
                            </div>
                            ...
                            <div class="form-group input-control">
                                    ...
                                    autocomplete="off" value="<?php echo $medecin['mdp']?>">
                                    <div class="error"></div>
                            </div>
                            ...
                            <div class="form-group input-control">
                                    ...
                                    autocomplete="off" value='<?php echo $medecin['salaire']?>'>
                                    <div class="error"></div>
                            </div>
                            ...
                            <option value="néphrologie" <?php echo ($medecin['specialite'] == 'néphrologie') ? 'selected' : ''; ?>>Néphrologie</option>
                                ...
                                <div class="error"></div>
                                                ...
                                                <button type="submit" name="ModifM" class="btn-send">Ajouter </button>
            </form>
                <?php
