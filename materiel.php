...
function addEquipment($tableName, $fieldName, $value) {
    global $connect;
    if (equipmentExists($tableName, $fieldName, $value)) {
        // Equipment already exists, handle accordingly
...
if(isset($_POST['remove_labour'])) {
    ...
    if($removed) {
        echo "<script>alert('Équipement supprimé avec succès de la catégorie Travail.');</script>";
        
    } else {
        echo "<script>alert('Échec de la suppression de l'équipement de la catégorie Travail.script>";
    }
}
    ...
    if(isset($_POST[$postName])) {
        ...
        if(empty($value)) {
            ...
            if(equipmentExists($tableName, $fieldName, $value)) {
                ...
                $added = addEquipment($tableName, $fieldName, $value);
                if($added) {
        ...
        <div class="info-data">
            <div class="card">
                ...
                <form action="" method="post">
                    <input type="text" name="add_general" placeholder="New Equipment Name" id="general" style="width: 250px;">
                    <input type="submit" class="btn btn-success" value="Ajouter un équipement général" onclick="verifmatgen()">
                </form>
            </div>
            ...
            <div class="card">
                ...
                <form action="" method="post">
                    <input type="text" name="add_labour" placeholder="New Equipment Name" id="labour" style="width: 250px;">
                    <input type="submit" class="btn btn-success" value="Ajouter de l'équipement de main-d'œuvre" onclick="veriflabour()">
                </form>
            </div>
            ...
            <div class="card">
                ...
                <form action="" method="post">
                    <input type="text" name="add_opd" placeholder="New Equipment Name" id="opd" style="width: 250px;">
                    <input type="submit" class="btn btn-success" value="Ajouter un équipement OPD" onclick="verifopd()">
                </form>
            </div>
        </div>
    </main>
