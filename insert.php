...
if(isset($_POST['submit_modification'])){
    $matriculep = mysqli_real_escape_string($connect, $_POST['matriculep']); 
    ...
    $query = "UPDATE patient SET matricule='$matriculep' , nom_p='$fname', prenom_p='$sname', username_p='$uname', pass_p='$password', naiss='$date', age='$age', sexe='$sexe', grp_sang='$sang',
 poids='$poids', allergie='$allergie', tel='$tel', `der_rdv_p`='$derr' 
 WHERE matricule='$matriculep'";
